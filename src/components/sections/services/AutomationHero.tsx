...
const AutomationHero: React.FC = () => {
  ...
  const keyFeatures = [
    ...
    { icon: BarChart3, text: 'Process Optimization' }
  ];
    ...
    <section className="relative bg-gradient-to-br from-teal-50 via-teal-100 to-cyan-200 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 pb-40 text-center relative z-10">
        ...
        >
          ...
          >
            Streamline operations and eliminate manual work with smart automation
          </motion.p>
          ...
          >
            Stop wasting time on repetitive tasks. Our AI-powered automation solutions 
            handle scheduling, inventory, customer management, and more - so you can 
