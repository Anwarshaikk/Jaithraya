  ...
  const steps = [
    {
      ...
      description: 'We analyze your target audience, their preferences, and engagement patterns to create a comprehensive engagement strategy.',
    },
    {
      number: '02',
      title: 'Content & Campaign Development',
      description: 'Our team develops engaging content and campaigns that resonate with your audience and drive meaningful interactions.',
    },
    {
      number: '03',
      title: 'Community Management',
      description: 'We manage your community, respond to interactions, and continuously optimize engagement strategies for maximum impact.',
    },
  ];
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            A strategic approach to building authentic relationships and driving meaningful engagement with your audience.
          </p>
        </div>
