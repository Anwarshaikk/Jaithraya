...
import { ArrowRight, Globe, Smartphone, Search, Zap } from 'lucide-react';
import { useConsultation } from '@/contexts/ConsultationContext';
import { Button } from '@/components/ui/Button';

const DigitalPresenceHero: React.FC = () => {
  ...
  const keyFeatures = [
    { icon: Globe, text: 'Modern Websites' },
    ...
    <section className="relative bg-gradient-to-br from-saffron-50 via-saffron-100 to-orange-200 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 pb-40 text-center relative z-10">
        ...
        >
          ...
          >
            Professional websites that attract and convert customers
          </motion.p>
          ...
          >
            ...
            We create modern, mobile-first websites that showcase your brand, build trust, 
...
export default DigitalPresenceHero;
