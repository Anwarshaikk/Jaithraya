...
const DigitalPresencePricing = () => {
  const plans = [
    {
      name: 'Foundation',
      price: '$1,500',
      frequency: 'One-time',
      description: 'Perfect for new businesses needing a professional online start.',
      features: [
        'Custom Landing Page',
    ...
    },
    {
      ...
      price: '$3,500',
      frequency: 'One-time',
      description: 'For growing businesses looking to expand their digital footprint.',
      features: [
    ...
    },
    {
      ...
      description: 'Tailored for established businesses with specific, larger-scale needs.',
      features: [
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            Choose the best plan that fits your business needs and goals.
          </p>
        </div>
...
export default DigitalPresencePricing;
