...
import { ArrowRight, MessageSquare, Heart, Users, Target } from 'lucide-react';
import { useConsultation } from '@/contexts/ConsultationContext';
import { Button } from '@/components/ui/Button';

const EngagementHero: React.FC = () => {
  ...
  const keyFeatures = [
    ...
    { icon: Heart, text: 'Loyalty Programs' },
    { icon: Users, text: 'Customer CRM' },
    { icon: Target, text: 'Personalized Marketing' }
  ];

  return (
    <section className="relative bg-gradient-to-br from-teal-50 via-teal-100 to-saffron-200 overflow-hidden">
      {/* Background Pattern */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="container mx-auto px-6 py-32 pb-40 text-center relative z-10">
        ...
        >
          ...
          >
            Turn one-time customers into loyal advocates with smart engagement
          </motion.p>
          ...
          >
            Your customers are your most valuable asset. We help you build meaningful 
            relationships through personalized communication, loyalty programs, and 
            automated follow-ups that keep customers coming back.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="mt-8">
            ...
            >
              Get Your Free Engagement Audit
