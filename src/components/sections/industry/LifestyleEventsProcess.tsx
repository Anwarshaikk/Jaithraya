...
const LifestyleEventsProcess = () => {
  const steps = [
    {
      number: '01',
      title: 'Brand Discovery',
      description: 'We dive deep into your brand story, values, and vision to create a digital strategy that authentically represents your lifestyle brand and resonates with your target audience.',
    },
    {
      number: '02',
      title: 'Creative Implementation',
      description: 'Our team brings your vision to life through stunning websites, engaging social media content, and memorable event experiences that captivate and inspire your community.',
    },
    {
      number: '03',
      title: 'Community Growth',
      description: 'We help you build and nurture a loyal community of followers who become brand advocates, driving organic growth and creating lasting relationships with your customers.',
    },
  ];
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">
            Our Lifestyle Brand Process
          </h2>
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            A creative and strategic approach to building memorable lifestyle brands and unforgettable events.
          </p>
        </div>
...
export default LifestyleEventsProcess;
