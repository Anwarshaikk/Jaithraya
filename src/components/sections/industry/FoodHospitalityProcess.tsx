...
const FoodHospitalityProcess = () => {
  const steps = [
    {
      number: '01',
      title: 'Discovery & Strategy',
      description: 'We analyze your restaurant\'s unique needs, target audience, and competitive landscape to create a customized digital strategy that drives foot traffic and online orders.',
    },
    {
      number: '02',
      title: 'Implementation & Launch',
      description: 'Our team builds your digital presence, from website to social media, reservation systems to online ordering, ensuring everything works seamlessly together.',
    },
    {
      number: '03',
      title: 'Optimization & Growth',
      description: 'We continuously monitor performance, gather customer feedback, and optimize your digital presence to increase bookings, orders, and customer satisfaction.',
    },
  ];
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">
            Our Restaurant Digital Strategy
          </h2>
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            A proven process to elevate your restaurant's digital presence and drive more customers through your doors.
          </p>
        </div>
...
export default FoodHospitalityProcess;
