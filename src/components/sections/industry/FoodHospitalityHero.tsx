...
import { ArrowRight, Utensils, Clock, Users, Smartphone } from 'lucide-react';
import { useConsultation } from '@/contexts/ConsultationContext';
import { Button } from '@/components/ui/Button';

const FoodHospitalityHero: React.FC = () => {
  ...
  const keyFeatures = [
    { icon: Utensils, text: 'Online Ordering' },
    { icon: Clock, text: 'Kitchen Management' },
    { icon: Users, text: 'Customer Experience' },
    ...
    <section className="relative bg-gradient-to-br from-saffron-50 via-saffron-100 to-teal-200 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 pb-40 text-center relative z-10">
        ...
        >
          ...
          >
            AI-powered solutions for restaurants, food trucks, and hospitality businesses
          </motion.p>
          ...
          >
            From quick-service restaurants to food trucks, catering to B&Bs - we help food and 
            hospitality businesses streamline operations, enhance customer experience, and boost revenue.
          </motion.p>
...
export default FoodHospitalityHero;
