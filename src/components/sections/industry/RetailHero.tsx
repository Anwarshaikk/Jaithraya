...
import { ArrowRight, ShoppingCart, BarChart3, Users, Smartphone } from 'lucide-react';
...
const RetailHero: React.FC = () => {
  ...
  const keyFeatures = [
    { icon: ShoppingCart, text: 'POS Integration' },
    { icon: BarChart3, text: 'Inventory Analytics' },
    { icon: Users, text: 'Customer Loyalty' },
    { icon: Smartphone, text: 'Mobile Management' }
  ];
    ...
    <section className="relative bg-gradient-to-br from-teal-50 via-teal-100 to-cyan-200 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 pb-40 text-center relative z-10">
        ...
        >
          ...
          >
            AI-powered inventory management and customer analytics for specialty retail
          </motion.p>
          ...
          >
            From convenience stores to boutiques, smoke shops to coffee shops - we help specialty retail 
            businesses optimize inventory, boost sales, and build lasting customer relationships.
          </motion.p>
